...
TASKS = (GradingTask(1, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(2, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(3, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(4, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(5, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(6, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(7, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(8, 'estimate', 8, ESTIMATE_TIMEOUT),
         GradingTask(1, 'defense', 2, DEFENSE_TIMEOUT),
         GradingTask(2, 'defense', 2, DEFENSE_TIMEOUT),
         GradingTask(3, 'defense', 2, DEFENSE_TIMEOUT),
         GradingTask(4, 'defense', 2, DEFENSE_TIMEOUT),
         GradingTask(5, 'defense', 2, DEFENSE_TIMEOUT),
         GradingTask(6, 'defense', 2, DEFENSE_TIMEOUT),
         GradingTask(7, 'defense', 2, DEFENSE_TIMEOUT),
         GradingTask(8, 'defense', 2, DEFENSE_TIMEOUT))

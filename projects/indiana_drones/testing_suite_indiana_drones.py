    ...
    def run_with_params(self, params: Dict):
        ...
        try:
            ...
            for move in params['move']:
                ...
                belief = indiana_drones_slam.process_movement(float(action[1]), float(action[2]))
    ...
    def run_with_params(self, params: Dict):
        ...
        if DEBUGGING_SINGLE_PROCESS:
            ...
            if test_process.is_alive():
                ...
                result = self.FAIL_TEMPLATE.format(message=error_message, needed_treasure = ['*'], collected=False, crashes = [], **params)
                score = 0.0

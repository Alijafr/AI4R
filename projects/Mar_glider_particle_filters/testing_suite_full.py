...
# (Note: PLOT_MAP requires PLOT_PARTICLES Visualization!)
...
# The real test cases will be generated using generate_params_marsglider.py
    ...
    def simulate_without_steering(self, estimate_next_pos, params):
        ...
        try:
            while steps < params['max_steps']:
                ...
                if PLOT_PARTICLES is True and extra_points is not None:
                ...
                if VERBOSE is True:
                    ...
                    print(
                        "\nStep: {} Actual ({})  predicted: ({})\n  Difference = {}\n  Height={}, Ground Height = {} Dist To Ground = {}".format(
                            steps, target_pos, estimate, separation, actual_height, ground_height,
                    ...
                    if extra_points is not None and len(extra_points) > 0:
                        ...
                        print("{} Particles, Min dist: {}, Avg dist: {}, Max Dist: {}".format(len(extra_points), pMin,
                                                                                              pAvg, pMax))

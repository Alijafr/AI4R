...
class MatplotlibVisualizer(DroneListener):
    ...
    def initialize(self, target_elevation, target_x, simulation_length):
        self.target_ys = [target_elevation for i in range(simulation_length+1)]
        self.target_xs = [target_x for i in range(simulation_length+1)]
    ...
    def update(self, x, y, roll_angle, thrust, roll, rpm_left, rpm_right):

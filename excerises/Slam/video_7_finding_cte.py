...
# -*- coding: utf-8 -*-
"""
Note: the formula for CTE should actually take the square root of the 
denominator, i.e. (Ry dx - Rx dy) / sqrt(dx^2 + dy^2), but if you implement it 
as shown in lecture it will work well enough to pass the grader.
"""
# -----------
# User Instructions
#

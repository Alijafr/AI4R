...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    Omega = matrix()
    Omega.zero(dim, dim)
    Omega.value[0][0] = 1.0 #first x constraint
    Omega.value[1][1] = 1.0 #first y constraint 
    ...
    for k in range(len(data)):
        ...
        #n is the index of the robot pose in the matrix/vecotr 
        n = k*2 #because each pose has x and y
